...
shell_script = f"""
    wp core install --url={environ['DOMAIN_NAME']} --title={environ['WP_TITLE']} --admin_user={environ['WP_ADMIN_USER']} --admin_password={environ['WP_ADMIN_PASSWORD']} --admin_email={environ['WP_ADMIN_EMAIL']} --path=/var/www/html --allow-root
